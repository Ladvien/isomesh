...
///
/// 65 puts a 0.125 cell against a crater rim that is often under a unit across,
/// so the holes a shot leaves come out visibly polygonal — and the holes are
/// what anyone watching this is looking at. 97 halves the cell and costs about
/// 7 ms a re-mesh, against a shot every 0.9 s.
const TARGET_SAMPLES: u32 = 97;

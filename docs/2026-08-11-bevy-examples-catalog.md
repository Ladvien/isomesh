...
| 20 | `attribute_transfer` | **Paint survives destruction** | Spray colour on a wall, then blow a hole through it. The paint on the remaining wall must be exactly where you sprayed it — not smeared, not reset. Row 4 of the opportunities table, and the cheapest genuinely-new thing in it. |
